...
| <img width="50" src="https://cdn.auth0.com/blog/brand-evolution-logo-Auth0-shield-black-background-Squared.png"> | <div style="text-align: left;">[Create an Auth0 account; it's free!](https://a0.to/try-auth0)</div> |
| :----------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
