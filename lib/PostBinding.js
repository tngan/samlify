        ...
        base64LoginResponse: function base64LoginResponse(requestInfo,referenceTagXPath,entity,user,rcallback){
            ...
            if(metadata && metadata.idp && metadata.sp) {
                ...
                if(metadata.sp.isWantAssertionsSigned()) {
                    return SamlLib.constructSAMLSignature(rawSamlResponse,referenceTagXPath,metadata.idp.getX509Certificate('signing'),idpSetting.privateKeyFile,idpSetting.privateKeyFilePass,idpSetting.requestSignatureAlgorithm); // SS1.1 add signature algorithm
                    // No need to embeded XML signature
