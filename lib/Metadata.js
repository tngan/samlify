...
certUse = require('./urn').wording.certUse,
...
module.exports = function(meta,extraParse,isXml){
    ...
    * @param  {string} use          declares the type of certificate (e.g. signing, encrypt)
    * @param  {string} certFile     declares the .cer file (e.g. path/certificate.cer)
    * @return {object} object used in xml module
    */
    Metadata.prototype.createKeySection = function createKeySection(use,certFile){
        return {
            KeyDescriptor:[{
                _attr: {use: use}
            },{
