...
(() => {
  test("fetch multiple attributes", (t: ExecutionContext) => {
  ...
  test("fetch single attributes", (t: ExecutionContext) => {
    const result = extract(_decodedResponse, [
      {
        key: "statusCode",
  ...
  test("fetch the inner context of leaf node", (t: ExecutionContext) => {
    const result = extract(_decodedResponse, [
      {
        key: "audience",
        localPath: [
  ...
  test("fetch the entire context of a non-existing node ", (t: ExecutionContext) => {
    const result = extract(_decodedResponse, [
      {
  ...
  test("fetch the entire context of an existed node", (t: ExecutionContext) => {
    const result = extract(_decodedResponse, [
      {
  ...
  test("fetch the unique inner context of multiple nodes", (t: ExecutionContext) => {
    const result = extract(_decodedResponse, [
      {
        key: "issuer",
        localPath: [
  ...
  test("fetch the attribute with wildcard local path", (t: ExecutionContext) => {
  ...
  test("fetch the attribute with non-wildcard local path", (t: ExecutionContext) => {
    const result = extract(_decodedResponse, [
      {
        key: "attributes",
  ...
  test("fetch with one attribute as key, another as value", (t: ExecutionContext) => {
    const result = extract(_spmeta, [
      {
