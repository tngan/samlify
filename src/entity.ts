...
import { algorithms, messageConfigurations, namespace, wording } from "./urn";
...
export default class Entity {
  ...
  createLogoutRequest(
    ...
    if (binding === wording.binding.post) {
      const entityEndpoint = targetEntity.entityMeta.getSingleLogoutService(
        binding
      );
